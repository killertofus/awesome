pkgToRemoveListFull=" emacsen-common dictionaries-common $DESKTOP_SESSION  slick-greeter celluloid gnome-games gnome-terminal hypnotix hexchat orca xterm nano transmission libreoffice-base-core p7zip-full rhythmbox-tray-icon rhythmbox-data rhythmbox-plugins snapd snap rhythmbox vim-common vim-tiny warpinator youtube-dl yelp *gnome*"
pkgToRemoveList=""
