...
echo 'deb https://download.opensuse.org/repositories/shells:/zsh-users:/zsh-autosuggestions/Raspbian_11/ /' | sudo tee /etc/apt/sources.list.d/shells:zsh-users:zsh-autosuggestions.list
